...
//    struct ref_point ref_a = {};
    ...
    _offboard_sp.ignore_attitude = false;//true
...
//            wgs_ned(&ref_a, _vehicle_global_position.lat, _vehicle_global_position.lon, &x_now, &y_now);
		...
		//printf("A-channel8:%6.3f",(double)_rc_channels.channels[7]);
            ...
            case 5:     //C点降落
                ...
                _offboard_sp.x = local_c.x;
                _offboard_sp.y = local_c.y;
                _offboard_sp.z = local_c.z - (float)1.0;
            ...
            case 6:     //C点悬停投放，下一步C点起飞
                ...
                _offboard_sp.x = local_c.x;
                _offboard_sp.y = local_c.y;
                _offboard_sp.z = local_c.z - (float)0.2;
